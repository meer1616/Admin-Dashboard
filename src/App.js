...
function App() {
  const { activeMenu, themeSettings, setThemeSettings, currentColor, currentMode } = useStatContext();
        ...
        <BrowserRouter>
          <div className="relative flex dark:bg-main-dark-bg">
            ...
            <div
              className={
                activeMenu
                  ? "translateit dark:bg-main-dark-bg bg-main-bg min-h-screen md:ml-72 w-full"
